...
import 'package:bite_nearby/services/api_service.dart';
...
class _MenuPageState extends State<MenuPage>
  ...
  Future<void> _fetchPersonalizedMenu() async {
    try {
      ...
      final List<String> allergies = List<String>.from(data['allergens'] ?? []);
      ...
      setState(() {
        personalizedMenu = recommendations
            .map((rec) => {
                  'name': rec.name,
                  'imageUrl': rec.imageUrl,
                  'ingredients': rec.mainIngredients
                })
            .toList();
      });
    } catch (e) {
      print('Error fetching personalized menu: $e');
    }
  }
